...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = (waypoint, inputs['light'], inputs['oncoming'], inputs['right'], deadline < (initial_deadline / 3.0))
    ...
    def createQ(self, state):
        ...
        if self.Q.has_key(state) == False:
            d1 = dict()
            for v in self.env.valid_actions:
                d1[v] = 0.0
            self.Q[state] = d1
    ...
    def learn(self, state, action, reward):
        ...
        a = (1-self.alpha) * self.Q[state][action]
        b = self.alpha * reward
